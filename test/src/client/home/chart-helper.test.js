...
test('converts questionnaire results to dataset', (t) => {
  ...
  const expected = [
    { topic: 'Before you Start a Social Business', totals: { true: 1, total: 1, proportion: 1 } },
    { topic: 'Starting a Social Business', totals: { true: 4, total: 4, proportion: 1 } },
    { topic: 'Running a Social Business', totals: { true: 1, false: 2, total: 3, proportion: 0.3333333333333333 } },
    { topic: 'Growing A Social Business', totals: { false: 4, total: 4, proportion: 0 } },
    { topic: 'Case Studies', totals: { false: 1, total: 1, proportion: 0 } },
  ];
